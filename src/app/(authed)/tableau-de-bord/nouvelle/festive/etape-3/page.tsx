...
export default function FestiveStep3Page() {
  ...
  // Banani festive default = Privée. Solidaire default = Publique.
  ...
  async function handlePublish() {
    ...
    try {
        ...
        "/api/blocks",
        {
          ...
          body: {
            ...
            config: {
              ...
              // CRITICAL — backend superRefine rejects non-null cause /
              // beneficiary when subtype === "festive".
              cause: null,
              beneficiary: null,
              visibility,
              hideAmount,
      ...
      // Don't clear the draft here — success page clears via DraftClearer
      // on mount. router.replace prevents back-button re-submit.
      router.replace(
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <WizardHeader
        ...
        subtitle={WIZARD_LABELS.step3SubtitleFestive}
      />
      ...
      >
        ...
        <div className="border-t border-border pt-6">
          <Checkbox
            ...
            label={WIZARD_FIELDS.tosLabelFestive}
